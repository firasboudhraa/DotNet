...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
       ...
       ,
        ...
        public static Flight flight3 = new Flight { FlightDate = new DateTime(2022, 02, 03, 5, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 03, 01, 6, 40, 10), EstimateDuration = 100, plane = BoingPlane };
        public static Flight flight4 = new Flight { FlightDate = new DateTime(2022, 02, 02, 6, 10, 10), Destination = "Madrid", EffectiveArrival = new DateTime(2022, 04, 01, 8, 10, 10), EstimateDuration = 130, plane = BoingPlane };
